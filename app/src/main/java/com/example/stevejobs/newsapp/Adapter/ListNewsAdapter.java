package com.example.stevejobs.newsapp.Adapter;
...
import com.example.stevejobs.newsapp.Common.ISO8601Parse;
import com.example.stevejobs.newsapp.DetailArticle;
import com.example.stevejobs.newsapp.Interface.ItemClickListener;
import com.example.stevejobs.newsapp.Model.Article;
import com.example.stevejobs.newsapp.R;
...
/**
 * Created by SteveJobs on 1/21/2018.
 */
...
class ListNewsViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener
{
    ...
    CircleImageView article_imaage;

    public ListNewsViewHolder(View itemView) {
        super(itemView);

        article_imaage = (CircleImageView) itemView.findViewById(R.id.article_image);
...
public class ListNewsAdapter extends RecyclerView.Adapter<ListNewsViewHolder> {
    ...
    public void onBindViewHolder(ListNewsViewHolder holder, int position) {
        ...
        Picasso.with(context).load(articleList.get(position).getUrlToImage()).into(holder.article_imaage);
